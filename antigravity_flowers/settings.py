...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-9n-=6s0t605967d=jcv8v4%utt=ji^fk4wa7b9^*8bw_0nl2=^')
...
ROOT_URLCONF = 'antigravity_flowers.urls'
...
WSGI_APPLICATION = 'antigravity_flowers.wsgi.application'
...
# Email backend configuration (Console in development)
